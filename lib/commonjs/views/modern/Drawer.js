...
function Drawer(_ref) {
  ...
  let panGesture = _reactNativeGestureHandler.Gesture.Pan().activeOffsetX([-SWIPE_DISTANCE_MINIMUM, SWIPE_DISTANCE_MINIMUM]).hitSlop(hitSlop).enabled(drawerType !== 'permanent' && swipeEnabled).onStart(event => {
  ...
  panGesture.config = { ...panGesture.config,
    ...gestureHandlerProps
  };
