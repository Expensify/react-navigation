...
export default function Drawer(_ref) {
  ...
  let panGesture = Gesture.Pan().activeOffsetX([-SWIPE_DISTANCE_MINIMUM, SWIPE_DISTANCE_MINIMUM]).hitSlop(hitSlop).enabled(drawerType !== 'permanent' && swipeEnabled).onStart(event => {
